...
/// <summary>Validation rules for <see cref="UpdateOwnSteamId64Command"/>.</summary>
public class UpdateOwnSteamId64CommandValidator : AbstractValidator<UpdateOwnSteamId64Command>
{
	#region Constructors

	public UpdateOwnSteamId64CommandValidator()
	{
