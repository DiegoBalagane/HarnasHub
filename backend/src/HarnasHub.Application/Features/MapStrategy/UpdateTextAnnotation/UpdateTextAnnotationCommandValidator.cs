...
/// <summary>Validation rules for <see cref="UpdateTextAnnotationCommand"/>.</summary>
public class UpdateTextAnnotationCommandValidator : AbstractValidator<UpdateTextAnnotationCommand>
{
	#region Constructors

	public UpdateTextAnnotationCommandValidator()
	{
		RuleFor(x => x.Text)
