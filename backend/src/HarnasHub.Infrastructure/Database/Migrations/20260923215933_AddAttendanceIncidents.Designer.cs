...
namespace HarnasHub.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260923215933_AddAttendanceIncidents")]
    partial class AddAttendanceIncidents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HarnasHub.Core.Entities.AnalysisBoard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("BackgroundImageObjectKey")
                        .HasMaxLength(300)
                    ...
                    b.ToTable("AnalysisBoards", (string)null);
                });

            modelBuilder.Entity("HarnasHub.Core.Entities.AttendanceIncident", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AttendanceIncidents", (string)null);
                });
            ...
            modelBuilder.Entity("HarnasHub.Core.Entities.PlayerMatchStat", b =>
                {
                    ...
                    b.Property<string>("DeathPositionsJson")
                        .HasColumnType("text");

                    b.Property<int>("Deaths")
                        .HasColumnType("integer");

                    b.Property<string>("DemoPlayerName")
                        .HasColumnType("text");

                    b.Property<int?>("EntryDeaths")
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("KastPercentage")
                        .HasColumnType("double precision");
                    ...
                    b.Property<int?>("MultiKill2K")
                        .HasColumnType("integer");

                    b.Property<int?>("MultiKill3K")
                        .HasColumnType("integer");

                    b.Property<int?>("MultiKill4K")
                        .HasColumnType("integer");

                    b.Property<int?>("MultiKill5K")
                        .HasColumnType("integer");
